        ...
        for index in range(self.index_begin, self.index_end):
            ...
            try:
                ...
                if package_response.status_code == 200:
                    ...
                    os.makedirs(local_dir + package_info["name"], 0o644, True)
...
def update_index(platform = ""):
    os.makedirs(base_path + "whl/", 0o644, True)
    ...
    try:
        ...
        if projects_list_response.status_code == 200:
            ...
            os.makedirs(local_dir, 0o644, True)
...
'''
    ...
    for platform in compute_platforms:
        os.makedirs(base_path + "whl/" + platform + "/", 0o644, True)
